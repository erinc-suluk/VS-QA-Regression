...
public class TopicLandingPage extends HelperFunctions {
	...
	@FindBy(xpath="//coral-columnview-item[@title='COVID-19']//coral-columnview-item-thumbnail[@role='presentation']")
	...
	@FindBy(xpath="//button[@aria-label='Remove: Value Store : Topic / COVID-19']//coral-icon[@aria-label='close']")
	...
	public void setTopicHeader(ExtentTest test) throws Exception {
	  ...
	  /*  Driver.getDriver().get(read1.getCellData("VALUE", 9));
	    ...
	    HelperFunctions.staticWait(2);
	    WebDriverWait wait2 = new WebDriverWait(Driver.getDriver(), 10);
	    WebElement visibleElement2 = wait2.until(ExpectedConditions.visibilityOf(topicPageTitle));
	    ...
	    HelperFunctions.staticWait(3);
	    WebDriverWait wait4 = new WebDriverWait(Driver.getDriver(), 10);
	    WebElement visibleElement4 = wait4.until(ExpectedConditions.visibilityOf(topicPageTitle));
	    ...
	    openPro.click();
	    HelperFunctions.waitForPageToLoad(30);
	    wait4.until(ExpectedConditions.visibilityOf(titleField));
	...
	public void setPageTags(ExtentTest test) throws Exception {
	   ...
	   /* Driver.getDriver().get(read1.getCellData("VALUE", 9));
	    ...
	    path2.click();
	    wait4.until(ExpectedConditions.visibilityOf(path3));
	    path3.click();
	    wait4.until(ExpectedConditions.visibilityOf(path4));
	    path4.click();
	    HelperFunctions.staticWait(2);
        selectButton.click();
        HelperFunctions.staticWait(2);
